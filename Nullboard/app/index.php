...
<body>
	<div class=logo>
		...
		<div class=bulk>
			...
			<a href="https://github.com/jcurtis4207/nullboard" target=_blank>Github</a>
		</div>
	</div>
	<div class=config>
...
<script src="JS/BoardFunctions.js" type="text/javascript"></script>
<script src="JS/NoteFunctions.js" type="text/javascript"></script>
